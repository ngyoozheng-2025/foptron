...
public class GameEngine extends JFrame implements KeyListener {
    ...
    public GameEngine(Characters character, String arenaName) {
        this(character, arenaName, "EASY"); // default difficulty if not specified
    }

    // initialize game with selected character, arena and difficulty
    ...
    private void startNewRound() {
        ...
        // load and spawn enemies based on selected difficulty
